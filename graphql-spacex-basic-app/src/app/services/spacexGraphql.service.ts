...
export type LaunchDetailsQuery = (
  ...
  & { launch: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'mission_name' | 'launch_date_local' | 'details'>
    & { rocket: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export const LaunchesListDocument = gql`
  ...
  export class LaunchesListGQL extends Apollo.Query<LaunchesListQuery, LaunchesListQueryVariables> {
    document = LaunchesListDocument;
